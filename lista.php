  ...
  <div class="layout-main">
    ...
    <section class="layout-content">
      ...
      <div class="container">
        ...
        <p id="txtLista" class="h2 text-center">Crie aqui suas listas</p>

        <form action="" method="POST">

          <div class="form-group">
            <input type="text" class="form-control" placeholder="Crie uma lista" name="nome">
          </div>

          <div class="form-group">
            <input type="text" class="form-control" placeholder="Crie os Itens" name="itens"><br>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          $nome = $_POST["nome"];
          $itens = $_POST["itens"];
          $lista = "Nome da Lista: $nome <br> $itens";

          $conexao = conectarBanco();

          $sql = "INSERT INTO lista (nome, itens, email) VALUES (?, ?, ?)";
          $stmt = $conexao->prepare($sql);

          if ($stmt) {
            $stmt->bind_param("sss", $nome, $itens, $emailAutenticado);
